...
```{r Regional Rev Chart, echo=FALSE, fig.height=6, fig.width=8, message=FALSE, warning=FALSE}
...
```{r Regional Percent Rev Chart, echo=FALSE, fig.height=6, fig.width=8, message=FALSE, warning=FALSE}
...
```{r Scale Indicators, message=FALSE, warning=FALSE, include=FALSE}
...
```{r GDP Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Consumption Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Industrial Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Inflation Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Interest Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Unemployment Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Exchange Rate Plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Oil Price Plot, echo=FALSE, message=FALSE, warning=FALSE}
